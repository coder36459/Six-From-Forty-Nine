...
const delay = b => {
	...
	stopBtn.addEventListener("click", () => {
		...
		document.getElementById("number-of-matches").innerText = hit.length + " Matching numbers";
	});
...
const createCoupon = () => {
	...
	return coupon.innerHTML = `<table id="coupon-tab"><tr><th colspan="3">Coupon</th><th colspan="7" id="number-of-matches"></th></tr>${a.join("")}</table>`
}
createCoupon();
